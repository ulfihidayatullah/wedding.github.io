...
<div class="container">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <?php
			$result = mysqli_query($conn, "SELECT DISTINCT invoice, kode_customer, status, order_date, kode_produk, qty,terima,tolak, cek FROM produksi group by invoice");
			$no = 1;
			$array = 0;
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="detailorder.php?inv=<?= $row['invoice']; ?>" type="submit" class="btn btn-primary"><i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-striped">
						...
						?>
                        <tr>
                            <td colspan="6" class="text-right"><b>Grand Total =
                                    <?= number_format($grand, 0, ".", ".");  ?></b></td>
                        </tr>
                    </table>
                </div>
