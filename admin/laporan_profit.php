...
<div class="container">
            ...
            <form action="exp_profit.php" method="POST">
                <table>
                    <tr>
                        ...
                        <td><button type="submit" class="btn btn-success"><i class="glyphicon glyphicon-save-file"></i>
                                Export to Excel</button></td>
                        <td> &nbsp;</td>
    ...
    <table class="table table-striped">
        ...
        <?php
        if (isset($_POST['submit'])) {
            $result = mysqli_query($conn, "SELECT * FROM produksi WHERE terima = 1 and order_date between '$date1' and '$date2'");
            $no = 1;
            $total = 0;
    ...
    <table class="table table-striped">
        ...
        <tr>
            <td colspan="7" class="text-right bg-success" style="color: green;"><b>TOTAL PENDAPATAN BERSIH =
                    <?= number_format($total - $totalb); ?></b></td>
        </tr>
    <?php
        }
    ?>
